...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000, value = [min_payload, max_payload],
                                                marks = {0: '0', 100: '1000', 2000: '2000', 3000: '3000', 4000: '4000', 5000: '5000',
...
def get_pie_chart(launch_site):
    ...
    if launch_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names='class', title=f'Total Success Launches for {launch_site}')
    return fig
# TASK 4:
...
def get_scatter_chart(launch_site, payload):
    ...
    if launch_site == 'ALL':
        ...
        filtered_df = filtered_df[filtered_df['Launch Site'] == launch_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Correlation between Payload and Success for {launch_site}')
    return fig
